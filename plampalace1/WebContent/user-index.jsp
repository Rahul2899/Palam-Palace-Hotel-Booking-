...
<div class="top-navigation">
 ...
 -->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar"">
	    <div class="container">
	      <a class="navbar-brand" style="font-size: 250%" href="index.jsp">Palam<span> Palace</span></a>
	<!--       <img src="images\PalamPalace .png" alt="#" style="height: 150px;"> -->
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <a class="dropdown-item" style="color: black;" href="index_ahmedabad.jsp"><b>Ahmedabad</b></a>
              <a class="dropdown-item" style="color: black; " href="index_mumbai.jsp"><b>Mumbai</b></a>
               <!--  <a class="dropdown-item" href="product-single.html">Single Product</a> -->
              <a class="dropdown-item" style="color: black; "href="index_delhi.jsp"><b>Delhi</b></a>
                
              <!-- <a class="dropdown-item" style="color: black;"href="transferservice.html"><b>Transfer service</b></a> -->
              </div>		
	          
              <!-- <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: black;">Services</a>
              <div class="dropdown-menu"  aria-labelledby="dropdown04">
              <a class="dropdown-item" style="color: black;" href="rooms.html"><b>Rooms</b></a>
              <a class="dropdown-item" style="color: black; " href="restaurant.html"><b>Restaurant</b></a>
 ...
 -->
			 ...
			 <!-- <li class="nav-item"><a href="event.html" class="nav-link">Event</a></li> -->
	          <li class="nav-item"><a href="about.jsp" class="nav-link" style="color: black;">About Us</a></li>
	          <!-- <li class="nav-item"><a href="blog.html" class="nav-link">Blog</a></li> -->
	          <li class="nav-item"><a href="contact.jsp" class="nav-link" style="color: black;">Contact</a></li>
	          
	          

	          <a href="login.jsp" class="tn btn-outline-primary rounded text-center" style="margin-top:20px;width:150px;height: 40px;">Sign In/ Sign UP</a>
    ...
    <!-- END nav -->
	    ...
	    <section class="home-slider owl-carousel">
	      <div class="slider-item" style="background-image:url(images/hero_background.jpg);">
	      ...
	      <div class="slider-item" style="background-image:url(images/image5.jpg);">
	      	<!-- <div class="overlay"></div> -->
	        <div class="container">
	          <div class="row no-gutters slider-text align-items-center justify-content-end">
	          <div class="col-md-6 ftco-animate">
    ...
    <section class="ftco-booking ftco-section ftco-no-pt ftco-no-pb">
    	<div class="container">
    		<div class="row no-gutters">
    			<div class="col-lg-12">
    				<form action="CheckAvailablity" class="booking-form aside-stretch">
	        		<div class="row">
	        			...
	        			<div class="col-md d-flex py-md-4">
	        				<div class="form-group align-self-stretch d-flex align-items-end">
			                    ...
			                    <div class="icon"><span class="ion-ios-arrow-down"></span></div>
											...
											<input type="radio" id="dellhi" name="location" value="dellhi">
											<label for="dellhi">dellhi</label><br>
											<input type="radio" id="ahemdabad" name="location" value="ahemdabad">
											<label for="ahemdabad">ahemdabad</label><br>
	        			...
	        			<div class="col-md d-flex">
			              ...
			              <input type="submit" class="btn btn-primary py-5 py-md-3 px-4 align-self-stretch d-block"><span>Check Availability <small>Best Price Guaranteed!</small></span></a>
			            </div>
	        			</div>
	        		</div>
	        	</form>
        ...
        <div class="row d-flex">
          <div class="col-md px-md-1 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services active py-4 d-block text-center">
              ...
              <div class="media-body">
              	<a href="rooms.html"><button type="button" class="btn btn-outline-primary"style="color: #198754;border-color: #198754;background-color: transparent;">Rooms</button></a>
            ...
            <div class="media block-6 services py-4 d-block text-center">
              <div class="d-flex justify-content-center">
                <div class="icon d-flex align-items-center justify-content-center">
              		...
              		<svg xmlns="http://www.w3.org/2000/svg" width="50" height="40" fill="#21cc7a" class="bi bi-calendar2-event" viewBox="0 0 16 16">
              ...
              <div class="media-body">
            	<a href="event.html"><button type="button" class="btn btn-outline-primary" style="color: #198754;border-color: #198754;background-color: transparent;">Events</button></a>
          ...
          <div class="col-md px-md-1 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services active py-4 d-block text-center">
              ...
              <div class="media-body">
              <a href="restaurant.html"> <button type="button"class="btn btn-outline-primary" style="color: #198754;border-color: #198754;background-color: transparent;">Restaurant</button></a>
    ...
    <section class="ftco-section ftco-wrap-about ftco-no-pt ftco-no-pb">
			<div class="container">
	          ...
	          <div class="heading-section mb-4 my-5 my-md-0">
	            ...
	            <h2 class="mb-4">Palam Palace Hotel the Most Recommended Hotel All Over the World</h2>
	          </div>
...
<p>We aim to redefine a new dimension of luxury and relaxation.</p>
	          <p><a href="rooms.html" class="btn btn-secondary rounded">Reserve Your Room Now</a></p>
					</div>
				</div>
			</div>
		</section>
...
<!-- <section class="ftco-section ftco-no-pb ftco-room">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">203 Fake St. Mountain View,Singapur</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+919979059132</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">PalamPalace@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=Map_api&sensor=false"></script>
