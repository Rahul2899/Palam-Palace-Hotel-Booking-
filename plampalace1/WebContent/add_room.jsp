	                    ...
	                    <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
	                        ...
	                        <li class="nav-item">
	                            ...
	                            <ul class="sub-menu">
	                                ...
	                                <li class="nav-item">
	                                    <a href="all_staffs.jsp" class="nav-link ">
	                        ...
	                        <li class="nav-item">
	                            ...
	                            <ul class="sub-menu">
	                                <li class="nav-item">
	                                    <a href="add_vehicle.jsp" class="nav-link ">
	                                        <span class="title">Add Vehicle Details</span>
	                                    </a>
	                                </li>
	                                <li class="nav-item">
	                                    <a href="all_vehicles.jsp" class="nav-link ">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <form action="RoomController" method="post" enctype="multipart/form-data">
								...
								<div class="card-body row">
						            <div class="col-lg-6 p-t-20"> 
						              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     <input class = "mdl-textfield__input" type = "text" id = "room_no" name="room_no">
						            ...
						            <div class="col-lg-6 p-t-20"> 
						              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     <input class = "mdl-textfield__input" type = "file" id = "fname" name="fname">
					                     <label class = "mdl-textfield__label">Room Image</label>
					                  </div>
						            </div>
						            <div class="col-lg-6 p-t-20"> 
						              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
								            <input class="mdl-textfield__input" type="text" id="list3" value="" readonly tabIndex="-1" name="room_type">
					 ...
					 <ul data-mdl-for="list3" class="mdl-menu mdl-menu--bottom-left mdl-js-menu" >
								                <li class="mdl-menu__item" data-val="1" value="15" >Single</li>
								                <li class="mdl-menu__item" data-val="2" value="16">Double</li>
								                <li class="mdl-menu__item" data-val="3" value="17">Quad</li>
								                <li class="mdl-menu__item" data-val="4" value="18">King</li>
								                <li class="mdl-menu__item" data-val="5" value="19">Suite</li>
								                <li class="mdl-menu__item" data-val="6" value="20">Apartments</li>
								                <li class="mdl-menu__item" data-val="7" value="21">Villa</li>
								            </ul>			        </div>
						           	</div>
						           	 ...
						           	 <div class="col-lg-6 p-t-20"> 
						              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
								            <input class="mdl-textfield__input" type="text" id="bed_capacity" value="" readonly tabIndex="-1" name="bed_capacity">
								            <label for="list3" class="pull-right margin-0">
								                <i class="mdl-icon-toggle__label material-icons">keyboard_arrow_down</i>
								            </label>
								            <label for="list3" class="mdl-textfield__label">Bed Capacity</label>
								        
					 <ul data-mdl-for="bed_capacity" class="mdl-menu mdl-menu--bottom-left mdl-js-menu" >
								                <li class="mdl-menu__item" data-val="1" value="1" >1</li>
								                <li class="mdl-menu__item" data-val="2" value="2">2</li>
								                <li class="mdl-menu__item" data-val="3" value="3">3</li>
								                <li class="mdl-menu__item" data-val="4" value="4">4</li>
								                <li class="mdl-menu__item" data-val="5" value="5">5</li>
								                <li class="mdl-menu__item" data-val="6" value="6">6</li>
								                <li class="mdl-menu__item" data-val="7" value="7">7</li>
								            </ul>			        </div>
						           	</div>
						           	...
						           	<div class="col-lg-6 p-t-20"> 
						              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
								            <input class="mdl-textfield__input" type="text" id="sample2" value="" readonly tabIndex="-1" name="ac_nonac">
								            <label for="sample2" class="pull-right margin-0">
								                <i class="mdl-icon-toggle__label material-icons">keyboard_arrow_down</i>
								            </label>
								            <label for="sample2" class="mdl-textfield__label">AC/Non AC</label>
								            <ul data-mdl-for="sample2" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
								                <li class="mdl-menu__item" data-val="DE" value="AC">AC</li>
								                <li class="mdl-menu__item" data-val="BY" value="NonAC">Non AC</li>
								            </ul>
								        </div>
						            </div>
						            <div class="col-lg-6 p-t-20"> 
						              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
								            <input class="mdl-textfield__input" type="text" id="sample3" value="" readonly tabIndex="-1" name="meal">
								            ...
								            <ul data-mdl-for="sample3" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
								                <li class="mdl-menu__item" data-val="1" value="Free Breakfast">Free Breakfast</li>
								                <li class="mdl-menu__item" data-val="2" value="Free Dinner">Free Dinner</li>
								                <li class="mdl-menu__item" data-val="3" value="Free Breakfast and Dinner ">Free Breakfast and Dinner</li>
								                <li class="mdl-menu__item" data-val="4" value="Free Welcome Drink">Free Welcome Drink</li>
								                <li class="mdl-menu__item" data-val="5" value="Free Free Food">No Free Food</li>
								            </ul>
								        </div>
						            </div>
						            <div class="col-lg-6 p-t-20"> 
						              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
								          ...
								          <input class = "mdl-textfield__input" type = "text" id = "cancellation_charge" name="cancellation_charge">
					                     <label class = "mdl-textfield__label">Cancellation Charge</label>
						               ...
						               <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     <input class = "mdl-textfield__input" type = "text" 
					                        pattern = "-?[0-9]*(\.[0-9]+)?" id = "text8" name="tel">
						            ...
						            <div class="col-lg-6 p-t-20">
						              ...
						              <div class = "mdl-textfield mdl-js-textfield txt-full-width">
					                     <textarea name="room_summary" class = "mdl-textfield__input" rows =  "4" 
				...
				<option>${l1.branch_location}</option>
							         ...
							         <div class="col-lg-12 p-t-20 text-center"> 
						              	<input type="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-pink"></button>
