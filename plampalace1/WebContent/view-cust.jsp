...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white dark-sidebar-color logo-dark">
  <% 
                ...
                List<Customer> l=bl.getAllCustomer();
	                                    ...
	                                    <table class="table table-hover table-checkable order-column full-width" id="example4">
	                                        <thead>
	                                            <tr>
	                                                ...
	                                                <th class="center"> cust_name </th>
	                                                <th class="center"> cust_address </th>
	                                                <th class="center"> password </th>
	                                                <th class="center"> cust_email </th>
	                                                <th class="center"> cust_phone </th>
	                                                <th class="center">cust_idproof</th>
...
<td>:</td>
                                <td>${l.cust_id} </td>
                                <td>${l.cust_name} </td>
                                <td>${l.cust_address} </td>
                                <td>${l.password} </td>
                                <td>${l.cust_email} </td>
                                <td>${l.cust_phone} </td>
                                <td>${l.cust_idproof} </td>
                               
                                <td><a href="EditCustomerController?cust_id=${l.cust_id}"> Edit </a></td>
