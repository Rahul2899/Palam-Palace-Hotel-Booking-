	...
	<div class="wrap-menu-header gradient1 trans-0-4">
			<div class="container h-full">
				<div class="wrap_header trans-0-3">
					<!-- Logo -->
					<div class="logo" style="color: Black;" style="font-size: 250%"> <span>Palam Palace Restaurant</span>
						<a href="index.jsp">
							<!-- <span>Palam Palace Restaurant</span> -->
				...
				<div class="size23 w-full-md p-t-40 p-r-30 p-r-0-md">
					...
					<!-- 	<span class="txt25">Nulla vulputate</span>
						...
						<span class="txt25">lacus sodales</span>
						 sem, sit amet quam: -->
						<span class="txt24">9979059132</span>
					</p>
				</div>
