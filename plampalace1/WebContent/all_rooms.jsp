					...
					<div id="remove-scroll">
						<ul class="sidemenu page-header-fixed p-t-20"
							...
							<li class="nav-item active"><a href="#"
								...
								<ul class="sub-menu">
									<li class="nav-item"><a href="add_room.jsp"
										class="nav-link "> <span class="title">Add Room
												Details</span>
									</a></li>
									<li class="nav-item active"><a href="all_rooms.jsp"
										class="nav-link "> <span class="title">View All
												Rooms</span> <span class="selected"></span>
									</a></li>
							...
							<li class="nav-item"><a href="#" class="nav-link nav-toggle">
								...
								<ul class="sub-menu">
									<li class="nav-item"><a href="add_staff.jsp"
										class="nav-link "> <span class="title">Add Staff
												Details</span>
									</a></li>
									<li class="nav-item"><a href="all_staffs.jsp"
										class="nav-link "> <span class="title">View All
												Staffs</span>
									</a></li>
							...
							<li class="nav-item"><a href="#" class="nav-link nav-toggle">
								...
								<ul class="sub-menu">
									<li class="nav-item"><a href="add_vehicle.jsp"
										class="nav-link "> <span class="title">Add Vehicle
												Details</span>
									</a></li>
									<li class="nav-item"><a href="all_vehicles.jsp"
										class="nav-link "> <span class="title">View All
												Vehicle</span>
									</a></li>
								...
								<div class="card-body ">
									<div class="row p-b-20">
										<div class="col-md-6 col-sm-6 col-6">
											<div class="btn-group">
												<a href="add_room.jsp" id="addRow" class="btn btn-info">
										...
										<table
											...
											<thead>
												<tr>
													...
													<th class="center">Room Facility</th>
											...
											<tbody>
												...
												<tr class="odd gradeX">
													...
													<c:forEach items="${sessionScope.list1}" var="l1">
														...
														<tr>
															<td class="center">${l1.room_no }</td>
															<td class="center">${l1.room_type.room_type}</td>
															<td class="center">${l1.room_description }</td>
															<td class="center">${l1.rent }</td>
															<td class="center">${l1.hotelBranch.branch_location }</td>

															<td><a href="EditRoomController?id=${l1.room_id}">
																	Edit </a></td>
