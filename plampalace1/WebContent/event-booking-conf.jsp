...
<body>
	...
	<div align="center">
		<table border='1px'
			...
			<tr>
				<td>${sessionScope.hotelbranch.branch_name },
					${sessionScope.hotelbranch.branch_location}</td>
				<td>${sessionScope.event.ename}</td>
				<td>${sessionScope.event.price}</td>
			</tr>
		</table>

		<br>
		<form action="BookEvent">
			Enter your event date:<input type="date" name="edate"><br>
