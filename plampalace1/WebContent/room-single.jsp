          	...
          	<div class="row">
          		<div class="col-md-12 ftco-animate">
          			<div class="single-slider owl-carousel">
          				<div class="item">
          					<div class="room-img" style="background-image: url(images/${sessionScope.room.room_img});"></div>
          				</div>   				
          			</div>
          		</div>
          		<div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
          			<h2 class="mb-4">Room Type: ${sessionScope.room.room_type.room_type}<span><!-- - (4 Available rooms) --></span></h2>
    						<p>${sessionScope.room.room_summary}</p>
                   ...
                   <li><STRONG>Shower</STRONG></li><i class='fas fa-shower' style='font-size:48px;color:red'></i>
                   <li><STRONG>WiFi</STRONG></li><i class='fas fa-wifi' style='font-size:48px;color:red'></i>
	    						 <li><STRONG>concierge-bell</STRONG></li><i class='fas fa-concierge-bell' style='font-size:48px;color:red'></i>
                  </ul>
    						</div>
                ...
                <section>
                  ...
                  <div class="columcontrol section">
                    <div class="row">
                      <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="datapoints">
                          <div class="datapoints-wrapper-vertical">
                            <div class="row">
                            </div>
                            <div class="row">
                              <div class="Amenity list component">
                                <ul>
                                  <li>
                                    <span class="icon">
                                  ...
                                  <li>
                                   ...
                                   <li>
                                    ...
                                    <span class="text"> 
                                      Energy-efficient air-conditioning system with intelligent technology    
                                    </span>
                                  </li>
                                </ul>                                
                              </div>                              
