        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <form action="EditStaffController" method="post" enctype="multipart/form-data">
                     <div class="row">
						<div class="col-sm-12">
							<div class="card-box">
								...
								<div class="card-body row">
						            <div class="col-lg-6 p-t-20"> 
						              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     <input class = "mdl-textfield__input" type = "text" id = "staff_fname" name="staff_fname" value="${list.staff_fname}">
					                    ...
					                    <div class="col-lg-6 p-t-20"> 
						              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     <input class = "mdl-textfield__input" type = "text" id = "staff_lname" name="staff_lname" value="${list.staff_lname}">
					                     <label class = "mdl-textfield__label">staff lname</label>
					                  </div></div>
					                  
					                  
					                    <div class="col-lg-6 p-t-20"> 
						              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     <input class = "mdl-textfield__input" type = "email" id = "staff_email" name="staff_email" value="${list.staff_email}">
					                     <label class = "mdl-textfield__label">staff email</label>
					                  </div></div>
						           
						            <div class="col-lg-6 p-t-20"> 
						               <label class = "mdl-textfield__label">staff joinDate</label>
						              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     <input class = "mdl-textfield__input" type = "date" id = "staff_joinDate" name="staff_joinDate" value="${list.staff_joinDate}">
					                  
					                  </div></div>
						           
						            <div class="col-lg-6 p-t-20"> 
						              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     <input class = "mdl-textfield__input" type = "text" id = "staff_designationl" name="staff_designationl" value="${list.staff_designationl}">
					                     <label class = "mdl-textfield__label">staff designation</label>
					                  </div></div></div>
					                  
					                   <div class="col-lg-6 p-t-20"> 
						              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     <input class = "mdl-textfield__input" type = "text" id = "staff_phone" name="staff_phone" value="${list.staff_phone}">
					                     <label class = "mdl-textfield__label">staff phone</label>
					                  </div></div>
							              ...
							              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
									            ...
									            <label for="sample2" class="mdl-textfield__label">Gender</label><br>
									        <input type="radio" id="male" name="staff_geneder" value="male" value="${list.staff_geneder}">
											<label for="male">Male</label><br>
											<input type="radio" id="female" name="staff_geneder" value="female" value="${list.staff_geneder}">
						           ...
						           <div class="card-body row">
						            <div class="col-lg-6 p-t-20"> 
						              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     ...
					                     <input class = "mdl-textfield__input" type = "file" id = "staff_idproof"  name="staff_idproof" value="${list.staff_idproof}">
