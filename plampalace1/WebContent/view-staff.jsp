	                                    ...
	                                    <table class="table table-hover table-checkable order-column full-width" id="example4">
	                                        <thead>
	                                            <tr>
	                                                ...
	                                                <th class="center"> staff_fname </th>
	                                                <th class="center"> staff_lname </th>
	                                                <th class="center"> staff_email </th>
	                                                <th class="center"> staff_joinDate </th>
	                                                <th class="center"> staff_designationl </th>
	                                                <th class="center">staff_geneder</th>
	                                                  <th class="center"> staff_phone </th>
	                                                <th class="center"> staff_idproof </th>
...
<td>:</td>
                               <td>${l.staff_id} </td>
                                ...
                                <td>${l.staff_lname} </td>
                                <td>${l.staff_email} </td>
                                <td>${l.staff_joinDate} </td>
                                <td>${l.staff_designationl} </td>
                                <td>${l.staff_geneder} </td>
                                <td>${l.staff_phone} </td>
                                <td>${l.staff_idproof} </td>
                               
                                <td><a href="EditStaffController?staff_id=${l.staff_id}"> Edit </a></td>
                                  <td><a href="DeleteStaffController?staff_id=${l.staff_id}"> Delete </a></td>
