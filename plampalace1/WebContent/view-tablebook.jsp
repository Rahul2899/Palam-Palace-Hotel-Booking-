<%@page import="com.dao.RestaurantTableDaoImpl"%>
<%@page import="com.model.RestaurantTableBooking"%>
<%@page import="com.dao.EventDaoImpl"%>
<%@page import="com.model.EventBooking"%>
...
<body
	...
	<%
		...
		List<RestaurantTableBooking> l = restDao.getAllTableBookings();
				...
				<div class="sidemenu-container navbar-collapse collapse fixed-menu">
					<div id="remove-scroll">
						<ul class="sidemenu page-header-fixed p-t-20"
							...
							<li class="nav-item"><a href="#" class="nav-link nav-toggle">
									<i class="material-icons">vpn_key</i> <span class="title">Rooms</span>
								...
								<ul class="sub-menu">
									...
									<li class="nav-item"><a href="edit_room.html"
							...
							<li class="nav-item active"><a href="#"
								...
								<ul class="sub-menu">
									...
									<li class="nav-item active"><a href="all_staffs.html"
										class="nav-link "> <span class="title">View All
												Staffs</span> <span class="selected"></span>
									</a></li>
											...
											<table
												...
												<thead>
													<tr>
														...
														<th class="center">Hotel Branch</th>
													...
													<c:forEach items="${sessionScope.list}" var="l">
														...
														<tr>
															<td>${l.tableno}</td>
															<td>${l.noofGuests}</td>
															<td>${l.reservationDate}</td>
															<td>${l.reservationTime}</td>
															<td>${l.customer.cust_id}</td>
															<td>${l.hotelBranch.branch_location}</td>
