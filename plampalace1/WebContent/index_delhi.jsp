...
<html lang="en">
  <head>
    <title>Palam Palace, Delhi</title>
    <meta charset="utf-8">
...
<div class="top-navigation">
 ...
 -->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar"">
	    <div class="container">
	      <a class="navbar-brand" style="font-size: 250%" href="index.jsp">Palam<span> Palace, Delhi</span></a>
...
<!-- 	          <li class="nav-item dropdown">
 ...
 -->	          
              ...
              <div class="dropdown-menu"  aria-labelledby="dropdown04">
              <a class="dropdown-item" style="color: black;" href="fc-recom/room_list.jsp"><b>Rooms</b></a>
              <a class="dropdown-item" style="color: black; " href="pato-master/index.jsp"><b>Restaurant</b></a>
