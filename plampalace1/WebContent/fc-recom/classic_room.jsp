...
<head>
    ...
    <title>Palam Palace, Ahmedabad</title>
    ...
    <link rel="stylesheet" href="E:/NIRMA/SEM6/project/tem/Hotel_Destination_PalamPalace/css/style.css">
            ...
            <div class="main-menu">
                ...
                <a href="#" class="open_close" id="close_in"><i class="icon_set_1_icon-77"></i></a>
                 ...
                 <!-- <li class="nav-item active">  -->  
                   	<a href="E:\Raeesh\hoteldestination\WebContent\index.jsp" style="color: Black;">Home</a></li>
...
<div class="carousel_in">
    ...
    <h1 class="main_title_in">Classic Room</h1>
    <div class="container add_bottom_60">
        ...
        <div class="row">
         ...
         <div class="row">
                ...
                <div class="col-md-9">
                    <p>
                        Be it for business or leisure, our Deluxe Room provides you the ideal space to work or unwind, offering customised experience among the finest hotels in Singapore. It features an ensuite bathroom with a refreshing rain shower, an executive workspace with ergonomic Herman Miller desk chair and in-room entertainment in the form of local and cable TV channels.
                    </p>
            ...
            <div class="theiaStickySidebar">
            	<div class="box_style_1">
                    ...
                    <input name="room_type" id="room_type" type="hidden" value="Double room">	
                    	<div class="row">
                        	<div class="col-md-6 col-sm-6">
                            	<div class="form-group">
                                	<label>CheckIn date</label>
                            	   	<input class="startDate1 form-control datepick" type="text" data-field="date" data-startend="start" data-startendelem=".endDate1" readonly placeholder="CheckIn" id="check_in" name="check_in">
                            ...
                            <div class="col-md-6 col-sm-6">
                            	<div class="form-group">
                            	   ...
                            	   <input class="endDate1 form-control datepick" type="text" data-field="date" data-startend="end" data-startendelem=".startDate1" readonly placeholder="CheckOut" id="check_out" name="check_out">
                                   <span class="input-icon"><i class="icon-calendar-7"></i></span>
                               </div>
                            </div>
                        </div><!-- End row -->
                        ...
                        <a href="tel://9979059132" id="phone_2"><i class="icon_set_1_icon-91"></i>+919979059132</a>
