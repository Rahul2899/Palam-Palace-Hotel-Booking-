	...
	<nav
		...
		<div class="container">
			<a class="navbar-brand" style="font-size: 250%" href="index.jsp">Palam<span>
					Palace ${sessionScope.hotelbranch.branch_location}</span></a>
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<a
						...
						style="color: black;">Select Services</a>
					...
					<a
						class="nav-link dropdown-toggle" href="#" id="dropdown04"
						data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
						style="color: black;">Select City</a>
						<div class="dropdown-menu" aria-labelledby="dropdown04">
							<a class="dropdown-item" style="color: black;"
								href="CityController?hbid=2"><b>Ahmedabad</b></a> <a
								class="dropdown-item" style="color: black;"
								href="CityController?hbid=1"><b>Mumbai</b></a>
							<!--  <a class="dropdown-item" href="product-single.html">Single Product</a> -->
						...
						<div class="row">
							<div class="col-md d-flex py-md-4">
								<div
									...
									<div class="wrap align-self-stretch py-3 px-4">
										<label for="#">Check-in Date</label> <input type="date"
											name="checkin_date" class="form-control" pattern="yyyy-MM-dd"
							...
							<div class="col-md d-flex py-md-4">
								<div
									class="form-group align-self-stretch d-flex align-items-end">
									<div class="wrap align-self-stretch py-3 px-4">
										<label for="#">Check-out Date</label> <input type="date"
											pattern="yyyy-MM-dd" name="checkout_date"
							...
							<div class="col-md d-flex">
								<div class="form-group d-flex align-self-stretch">
									<button type="submit"
										...
										<span>Check Availability <small>Best Price
				...
				<div class="col-md px-md-1 d-flex align-self-stretch ftco-animate">
					<div class="media block-6 services active py-4 d-block text-center">
						...
						<div class="media-body">
							<a href="room.jsp"><button type="button"
              ...
              <div class="media-body">
				...
				<div
					...
					<div class="media block-6 services py-4 d-block text-center">
					  ...
					  <path
						...
						<div class="media-body">
							<a href="event.jsp"><button type="button"
									class="btn btn-outline-primary"
				...
				<div class="col-md px-md-1 d-flex align-self-stretch ftco-animate">
					<div class="media block-6 services active py-4 d-block text-center">
						...
						<div class="media-body">
							<a href="book-restaurant-table.jsp">
