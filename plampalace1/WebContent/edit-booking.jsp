...
<% 
                ...
                List<Customer> l2=bl.getAllCustomer();
    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
								...
								<div class="card-body row">
						            <div class="col-lg-6 p-t-20"> 
						              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     <input class = "mdl-textfield__input" type = "date" id = "booking_date" name="booking_date" value="${l.booking_date }">
					                     <label class = "mdl-textfield__label">booking_date</label>
					                  </div>
						            </div>
						            <div class="col-lg-6 p-t-20"> 
						              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     <input class = "mdl-textfield__input" type = "date" id = "checkin_date" name="checkin_date" value="${l.checkin_date }">
					                     <label class = "mdl-textfield__label">checkin_date</label>
					                  </div>
						            </div>
						            <div class="col-lg-6 p-t-20"> 
						              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     <input class = "mdl-textfield__input" type = "time" id = "checkin_time" name="checkin_time" value="${l.checkin_time }">
					                     <label class = "mdl-textfield__label">checkin_time</label>
					                  </div>
						            </div>
						             <div class="col-lg-6 p-t-20"> 
						              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     <input class = "mdl-textfield__input" type = "date" id = "checkout_date" name="checkout_date" value="${l.checkout_date }">
					                     <label class = "mdl-textfield__label">checkout_date</label>
					                  </div>
						            </div>
						            <div class="col-lg-6 p-t-20"> 
						              <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
					                     <input class = "mdl-textfield__input" type = "time" id = "checkout_time" name="checkout_time" value="${l.checkout_time }">
					                     <label class = "mdl-textfield__label">checkout_time</label>
					                  </div>
						            </div>
				...
				<option>${l1.branch.branch_location}</option>
				</c:forEach>
				</select>
				</div>
				            </div>
